...
if [ "$1" = "" ]
then
    echo "./create-and-used-distroless.sh [version-number]"
    echo ""
    echo " Example:"
    echo "./create-and-used-distroless.sh 15"
    exit 1
fi
export VERSION=$1
...
configure_parameters() {
    export CUSTOMEJRE_DOCKER_IMAGE=tyoshio2002/distroless17-used-service
    export DOCKERFILE_NAME_FOR_CUSTOM_JRE=Dockerfile-use-distroless17-for-LT1-1
